...
<section class="benefits">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-12">
				<div class="item-benefit">
					<img src="{{ asset('/assets/images/ic_globe-2.pn') }}g" class="icon" alt="">
					<h3 class="title">
						1-1 Mentoring
					</h3>
					<p class="support">
				...
				<div class="row">
					<div class="col-lg-4 col-12">
						<div class="item-review">
							...
							<p class="message">
								I was not really into code but after they teach me how to train my logic then I was really fall in love
								with code
							</p>
							<div class="user">
